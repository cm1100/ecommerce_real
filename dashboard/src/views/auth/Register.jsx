        ...
        <div className="bg-[#6f68d1] p-4 rounded-md">
          ...
          <form onSubmit={submit}>
            ...
            <div className="flex items-center w-full gap-3 mb-3">
              <input className="w-4 h-4 text-blue-600 overflow-hidden bg-gray-200 rounded border-gray-300
              focus:ring-blue " type="checkbox" name='checkbox' id ='checkbox'></input>
